...
void neural_network(float *input,
    ...
    double conv3_start_time = omp_get_wtime();
    ...
    double conv3_end_time = omp_get_wtime();
    ...
    double conv4_start_time = omp_get_wtime();
    ...
    double conv4_end_time = omp_get_wtime();
    ...
    double conv5_start_time = omp_get_wtime();
    ...
    double conv5_end_time = omp_get_wtime();
    ...
    double pool3_start_time = omp_get_wtime();
    ...
    free(conv5_output);
    double pool3_end_time = omp_get_wtime();
    ...
    double fc6_start_time = omp_get_wtime();
    ...
    double fc6_end_time = omp_get_wtime();
    ...
    double fc7_start_time = omp_get_wtime();
    ...
    double fc7_end_time = omp_get_wtime();
    ...
    double fc8_start_time = omp_get_wtime();
    ...
    double fc8_end_time = omp_get_wtime();
